      ...
      <div className='flex flex-col sm:items-center md:items-start min-h-screen justify-start bg-gradient-to-r from-blue-200 to-purple-300'>
        ...
        <div className='flex flex-col justify-center'>
          <div className='flex m-4 '>
            <button
              className={`px-4 py-2 ${BUTTON_COLOR} text-white rounded `}
          ...
          <div className='flex m-4 '>
            <button
              className={`px-11 py-2 ${BUTTON_LIGHT_COLOR} text-white rounded `}
          ...
          <div className='lg:w-1/2 m-10'>
            <div
              ...
              <div className='w-full'>
                ...
                <button
                  className={`px-4 py-2 ${BUTTON_COLOR} text-white rounded hover:bg-gray-500 mb-10`}
